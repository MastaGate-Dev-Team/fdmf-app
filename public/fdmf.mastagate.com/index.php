				...
				<div class="row">
					...
					<div class="col-lg-6 col-12">
						...
						<div class="choose-rights">
								...
								<!--/ End Video Animation -->
								<img src="img/docta.jpg" alt="" class="img-fluid">
							</div>
						</div>
						<!-- End Choose Rights -->
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-12">
						...
						<div class="choose-rights">
								...
								<!--/ End Video Animation -->
								<img src="img/realisations.jpg" alt="" class="img-fluid">
							</div>
						</div>
						<!-- End Choose Rights -->
					</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news  h-100">
							<div class="news-head">
								<img src="img/Micromoteur.jpg" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="col-lg-4 col-md-6 col-12 mt-5">
							...
							<div class="single-news  h-100">
								<div class="news-head">
									<img src="img/Radiographie.jpg" alt="#">
								</div>
								<div class="news-body">
									<div class="news-content">
							...
							<div class="col-lg-4 col-md-6 col-12 mt-5">
								...
								<div class="single-news  h-100">
									<div class="news-head">
										<img src="img/Detrarteur.jpg" alt="#">
									</div>
									<div class="news-body">
										<div class="news-content">
